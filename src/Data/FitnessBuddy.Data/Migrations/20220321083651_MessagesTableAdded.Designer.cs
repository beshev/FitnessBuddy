...
namespace FitnessBuddy.Data.Migrations
{
    ...
    [Migration("20220321083651_MessagesTableAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitnessBuddy.Data.Models.ArticleRating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FitnessBuddy.Data.Models.ExerciseLike", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FitnessBuddy.Data.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FitnessBuddy.Data.Models.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FitnessBuddy.Data.Models.PostCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FitnessBuddy.Data.Models.Reply", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FitnessBuddy.Data.Models.UserFollower", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FitnessBuddy.Data.Models.ArticleRating", b =>
                {
                    b.HasOne("FitnessBuddy.Data.Models.Article", "Article")
                        .WithMany("ArticleRatings")
                        .HasForeignKey("ArticleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FitnessBuddy.Data.Models.ApplicationUser", "User")
                        .WithMany("RatedArticles")
            ...
            modelBuilder.Entity("FitnessBuddy.Data.Models.Message", b =>
                {
                    b.HasOne("FitnessBuddy.Data.Models.ApplicationUser", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FitnessBuddy.Data.Models.ApplicationUser", "Receiver")
                        .WithMany()
            ...
            modelBuilder.Entity("FitnessBuddy.Data.Models.Post", b =>
                {
                    ...
                    b.HasOne("FitnessBuddy.Data.Models.PostCategory", "Category")
                        .WithMany("Posts")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("FitnessBuddy.Data.Models.Reply", b =>
                {
                    ...
                    b.HasOne("FitnessBuddy.Data.Models.Reply", "Parent")
                        .WithMany()
                        .HasForeignKey("ParentId");

                    b.HasOne("FitnessBuddy.Data.Models.Post", "Post")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("FitnessBuddy.Data.Models.UserFollower", b =>
                {
                    b.HasOne("FitnessBuddy.Data.Models.ApplicationUser", "Follower")
                        .WithMany("Following")
