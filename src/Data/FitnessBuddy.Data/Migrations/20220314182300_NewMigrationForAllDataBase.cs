...
{
    public partial class NewMigrationForAllDataBase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodsNames", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Trainings_AspNetUsers_ForUserId",
                        column: x => x.ForUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersFavoriteFoods", x => new { x.FoodId, x.UserId });
                    table.ForeignKey(
                        name: "FK_UsersFavoriteFoods_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsersFavoriteFoods_Foods_FoodId",
                        column: x => x.FoodId,
                        principalTable: "Foods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExerciseEquipment_IsDeleted",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodsNames_IsDeleted",
                table: "FoodsNames",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_Meals_ForUserId",
                table: "Meals",
                column: "ForUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostCategories_IsDeleted",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainingsExercises_IsDeleted",
                table: "TrainingsExercises",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_TrainingsExercises_TrainingId",
                table: "TrainingsExercises",
                column: "TrainingId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersFavoriteFoods_UserId",
                table: "UsersFavoriteFoods",
                column: "UserId");
